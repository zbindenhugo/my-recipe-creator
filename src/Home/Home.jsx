...
function Home () {
    return (
        <Container fluid style={{textAlign: 'center'}}>
            ...
            <Container className='animate__animated animate__backInLeft animate__delay-2s home-text-container' fluid>
                <Row>
                    <Col>
